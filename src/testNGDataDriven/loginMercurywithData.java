...
public class loginMercurywithData {
	...
	public void doLogin() throws IOException {
		...
		driver.findElement(By.xpath("//input[@name='password']")).sendKeys(getData(0,1));
		try {
	...
	public String getData(int row, int cols) throws IOException{
		FileInputStream fis= new FileInputStream("C:\\Users\\ajit\\Desktop\\test\\mercury.xlsx");
		XSSFWorkbook workbook = new XSSFWorkbook(fis);
		XSSFSheet sheet = workbook.getSheetAt(0);
		//int rows= sheet.getPhysicalNumberOfRows();
		XSSFRow row1 = sheet.getRow(row);
		XSSFCell cell = row1.getCell(cols);
